...
export async function POST(request) {
  try {
    ...
    // Compatible/embedding nodes: populate providerSpecificData from the node config.
    // Multiple connections (API keys) are allowed per node for round-robin fallback.
